    ...
    if (isset($_POST['confirm-details-btn']))
    {
        ...
        if ($firstname == ""){
            ...
            if ($auth_user->update_details($uname, $firstname, $lastname, $username, $email, $notifications)){
                ...
                $message = "Hi $firstname $lastname\n\nAccount Details/Information updated. "
                        . "\nPlease keep information safely stored!!!";
...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link rel="stylesheet" href="./../Javascripts/stylesheet.css" type="text/css" />
...
<div class="container">  
    ...
    <script src="../Javascripts/check_input.js"></script>
